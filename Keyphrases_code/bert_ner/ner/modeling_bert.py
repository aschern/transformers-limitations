...
class BertForTokenClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.init_weights()
        self.use_positions = config.use_positions
    ...
    def forward(
        ...
        if self.use_positions:
            sequence_output = torch.cat((sequence_output, positions[:, :, None].type(torch.FloatTensor).cuda()), dim=-1)
